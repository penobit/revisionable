...
/*
 * This file is part of the Revisionable package by Penobit
 *
...
trait HasRevisions {
    ...
    /**
     * Ensure that the bootHasRevisions is called only
     * if the current installation is a laravel 4 installation
     * Laravel 5 will call bootHasRevisions() automatically.
     */
    public static function boot() {
        parent::boot();

        if (!method_exists(get_called_class(), 'bootTraits')) {
            static::bootHasRevisions();
        }
    }
